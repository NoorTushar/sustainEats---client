...
const DonationSection = () => {
   return (
      <div
         ...
         className="min-h-[200px] bg-center bg-cover bg-no-repeat bg-black bg-opacity-60 bg-blend-overlay bg-fixed py-12 md:py-20"
      >
         <div className="text-white">
            <Title title="Be a Hero" supTitle="Make a Donation"></Title>
         </div>

         <p className="text-white mx-auto max-w-4xl px-10">
            ...
            contributing, you are not only helping to sustain our platform but
            also making a significant impact on the lives of many individuals
            and families who struggle with food insecurity.
         </p>
